import type { Client, isFullPage, isFullDataSource } from "@notionhq/client";
...
export interface QueryDataSourcesParameters extends NonNullable<
  Parameters<Client["dataSources"]["query"]>[0]
> {}

export type DataSourcesPropertyConfigResponse = Asserts<
