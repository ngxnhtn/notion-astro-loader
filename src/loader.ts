...
import { zodToTs, printNode, createAuxiliaryTypeStore, createTypeAlias } from "zod-to-ts";
...
export function notionLoader({
  ...
  return {
    ...
    createSchema: async () => {
      ...
      const types = printNode(typeAlias);
